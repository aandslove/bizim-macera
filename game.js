...
function create() {
  ...
  statusText = this.add.text(20, 20, 'Odaya bağlanılıyor...', { 
    fontSize: '16px', fill: '#f1c40f', fontFamily: 'sans-serif' 
  });
...
function connectWebSocket() {
  ...
  socket.onclose = () => {
    statusText.setText('Bağlantı koptu, tekrar deneniyor...').setStyle({ fill: '#e17055' });
...
function update(time) {
  ...
  // Yumuşak İnterpolasyon (Karakter kayarak hareket eder)
  ...
  // Ağ Paketi Sınırlama (Tick Rate: Her 50 milisaniyede 1 paket - saniyede 20 paket)
